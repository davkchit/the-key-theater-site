...
export const afishaFull: AfishaItem[] = [
  ...
  { day: '13', mon: 'сентября', wd: 'воскресенье', title: 'Тратить деньги и хихикать', age: '12+', hall: 'Большой зал', time: '18:00', band: 'dark', accent: 'blue', thumb: photo3 },
  ...
  { day: '20', mon: 'сентября', wd: 'воскресенье', title: 'Эмиль из Леннеберги', age: '6+', hall: 'Большой зал', time: '17:00', band: 'dark', accent: 'red', thumb: photo1 },
