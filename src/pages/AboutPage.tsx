      ...
      <div className="mt-8 grid grid-cols-1 gap-10 lg:grid-cols-[1.35fr_.65fr]">
        <div className="text-[clamp(17px,1.9vw,21px)] leading-[1.65] text-[#2b2822]">
          ...
          <p className="mb-4.5">
            ...
            многие поступили в театральные вузы Казани, Самары, Петербурга и Москвы и стали профессиональными
        ...
        <Reveal className="relative self-start overflow-hidden rounded-3.5 bg-brand-blue p-6.5 text-paper">
          ...
          <div className="mt-2.5 text-[13px] leading-[1.5] opacity-85">Режиссёр, педагог и художественный руководитель театра «Ключ»</div>
      ...
      <div className="mt-13 grid grid-cols-1 gap-4 md:grid-cols-2">
        ...
        <Reveal index={1} className="relative overflow-hidden rounded-3.5 bg-brand-yellow p-7.5">
          ...
          <p className="relative text-base leading-[1.55]">
            Проводим ежегодно с 2012 года — к нам приезжают коллективы со всей России: Москва, Рязань, Ижевск,
            Чебоксары, Альметьевск и другие города. В программе — показы и мастерские для участников.
          </p>
          <NavLink
            to="/kontakty"
